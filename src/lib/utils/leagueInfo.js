/*   STEP 1   */
export const leagueID = "989255163598675968"; // your league ID
export const leagueName = "Farmers League Remastered"; // your league name
...
export const homepageText = `
  <p>A league designed to discover the largest Jabroni of them all.</p>
  <p>If by some miracle Jeremy ever wins a championship this league will be removed and all records will be scrubbed from existence.</p>
`;
...
export const managers = [
    ...
    //     image: "/managers/rival.jpg", // either a specific manager photo or '/managers/everyone.png' or '/managers/question.png'
    //   },
      "favoritePlayer": 167 // (optional) this corresponds to the Sleeper player ID (https://api.sleeper.app/v1/players/nfl)//   "philosophy": "Your fantasy team's philosophy",
